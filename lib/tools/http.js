...
exports.downloadLatestJXcore = function(cb) {
    ...
    exports.getLatestInfo(function(err, ret) {
      ...
      var d = new downloader(ret.platformUrl, zipFile);
      d.on('end', function(err, result) {
        ...
        unzipper.unzipFile(zipFile, ret.basename + path.sep + fname, process.cwd());
      });
    });
};
...
exports.getLatestInfo = function (cb) {
  ...
  exports.downloadString(_url, { silent : true }, function(err, str) {
    ...
    if (err) {
      ...
      if (!err) {
        var basename = 'jx_' + jxcore.utils.OSInfo().OS_STR.toLowerCase() + 'v8';
        ret = {
          urlPart : arr[0],  // e.g. https://jxcore.s3.amazonaws.com/0304
          verPart : arr[1],  // Beta-0.3.0.4
          verPartNormalized : jx.normalizeJXcoreVersion(arr[1]),  // e.g. 0304
          basename : basename,  // jx_osx64v8
          platformUrl : arr[0] + '/' + basename + '.zip'   // e.g.  https://jxcore.s3.amazonaws.com/0304/jx_osx64v8.zip
        }
      }
    }
